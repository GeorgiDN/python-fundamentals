...
def take_the_result(results, submissions, username, curr_language, curr_points):
    if username not in results:
        results[username] = {"language": curr_language, "points": curr_points}

    else:
        if curr_points > results[username]["points"]:
            results[username] = {"language": curr_language, "points": curr_points}
